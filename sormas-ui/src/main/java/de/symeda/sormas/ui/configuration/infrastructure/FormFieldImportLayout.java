...
public class FormFieldImportLayout extends AbstractImportLayout {

	public FormFieldImportLayout() {

		super();

		String templateFilePath;
		String templateFileName;
		String fileNameAddition = "_form_field_import_";
		...
		addImportCsvComponentWithOverwrite(2, allowOverwrite -> new ImportReceiver(fileNameAddition, file -> {
			...
			try {
				DataImporter importer = new de.symeda.sormas.ui.importer.FormFieldImporter(
					file,
					currentUser,
					allowOverwrite,
