...
public class CaseController {
	...
	protected CaseDataDto saveCase(CaseDataDto cazeDto) {
		...
		if (existingDto == null && cazeDto.getPerson() != null) {
			PersonHelper.validateRequiredFieldsForCaseCreation(FacadeProvider.getPersonFacade().getByUuid(cazeDto.getPerson().getUuid()));
		}
	...
	public CommitDiscardWrapperComponent<CaseFinalClassificationForm> getFinalClassificationEditComponent(final String caseUuid, ViewMode viewMode) {
		...
		editView.addCommitListener(() -> {
			...
			cazeDto.setRegionLabResultsReceived(finalClassificationForm.getValue().getRegionLabResultsReceived());
