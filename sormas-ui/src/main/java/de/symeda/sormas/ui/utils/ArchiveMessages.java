...
public enum ArchiveMessages {
	...
	LGA(Strings.headingConfirmArchiving,
		Strings.confirmationArchiveLga,
		Strings.confirmationArchiveLgas,
		Strings.messageLgaArchived,
		Strings.headingConfirmDearchiving,
		Strings.confirmationDearchiveLga,
		Strings.confirmationDearchiveLgas,
		Strings.messageLgaDearchived,
		Strings.headingNoRowsSelected,
		Strings.messageNoRowsSelected,
		null,
		null,
		Strings.messageCountEntitiesNotArchivedAccessDeniedReason,
		Strings.messageCountEntitiesNotDearchivedAccessDeniedReason,
		Strings.messageLgaArchivingNotPossible,
		null),
