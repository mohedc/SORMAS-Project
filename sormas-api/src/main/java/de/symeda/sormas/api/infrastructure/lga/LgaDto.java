...
@FeatureIndependent
public class LgaDto extends InfrastructureDtoWithDefault {

	private static final long serialVersionUID = -1610675328037466348L;

	public static final String I18N_PREFIX = "Lga";
	...
	public LgaReferenceDto toReference() {
		return new LgaReferenceDto(getUuid(), name, externalID);
	}

	public static LgaDto build() {
