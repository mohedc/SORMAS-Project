...
public interface Captions {
	...
	String CaseData_menac = "CaseData.menac";
	String CaseData_menacDate = "CaseData.menacDate";
	String CaseData_menacw = "CaseData.menacw";
	String CaseData_menacwDate = "CaseData.menacwDate";
	String CaseData_menacwy = "CaseData.menacwy";
	String CaseData_menacwyDate = "CaseData.menacwyDate";
	String CaseData_menaConjunate = "CaseData.menaConjunate";
	String CaseData_menaConjunateDate = "CaseData.menaConjunateDate";
	String CaseData_pcvi3I = "CaseData.pcvi3I";
	String CaseData_pcvi3IDate = "CaseData.pcvi3IDate";
	String CaseData_pcvi3_2 = "CaseData.pcvi3_2";
	String CaseData_pcvi3_2Date = "CaseData.pcvi3_2Date";
	String CaseData_pcv13_3 = "CaseData.pcv13_3";
	String CaseData_pcv13_3Date = "CaseData.pcv13_3Date";
	String CaseData_hibI = "CaseData.hibI";
	String CaseData_hibIDate = "CaseData.hibIDate";
	String CaseData_hib2 = "CaseData.hib2";
	String CaseData_hib2Date = "CaseData.hib2Date";
	String CaseData_hib3 = "CaseData.hib3";
	String CaseData_hib3Date = "CaseData.hib3Date";
	...
	String CaseData_dateLabResultsReceivedAtHealthFacility = "CaseData.dateLabResultsReceivedAtHealthFacility";
	...
	String Contact_contactProximitiesLongForm = "Contact.contactProximitiesLongForm";
	...
	String EpiData_travelHistoryKnown = "EpiData.travelHistoryKnown";
	String EpiData_travelLocation = "EpiData.travelLocation";
	String EpiData_travelLocation_region = "EpiData.travelLocation.region";
	String EpiData_travelLocation_district = "EpiData.travelLocation.district";
	String EpiData_travelLocation_community = "EpiData.travelLocation.community";
	...
	String EpiData_place = "EpiData.place";
	String EpiData_durationDays = "EpiData.durationDays";
	String EpiData_ddurationMonths = "EpiData.durationMonths";
	String EpiData_investigatorName = "EpiData.investigatorName";
	String EpiData_place2 = "EpiData.place2";
	String EpiData_durationMonths2 = "EpiData.durationMonths2";
	String EpiData_durationDays2 = "EpiData.durationDays2";
	String EpiData_place3 = "EpiData.place3";
	String EpiData_durationMonths3 = "EpiData.durationMonths3";
	String EpiData_durationDays3 = "EpiData.durationDays3";
	String EpiData_place4 = "EpiData.place4";
	String EpiData_durationMonths4 = "EpiData.durationMonths4";
	String EpiData_durationDays4 = "EpiData.durationDays4";
	...
	String Location_nearestHealthFacility = "Location.nearestHealthFacility";
	...
	String PathogenTest_dateFinalResultsSentToReportingHealthFacility = "PathogenTest.dateFinalResultsSentToReportingHealthFacility";
	...
	String PathogenTest_dateCombinedCellCultureResults="PathogenTest.dateCombinedCellCultureResults";
	String PathogenTest_dateResultsSentToNationalEpi="PathogenTest.dateResultsSentToNationalEpi";
	String PathogenTest_dateSentFromIcNationalRegLab="PathogenTest.dateSentFromIcNationalRegLab";
	String PathogenTest_dateDifferentiationSentEpi="PathogenTest.dateDifferentiationSentEpi";
	String PathogenTest_dateDifferentiationReceivedEpi="PathogenTest.dateDifferentiationReceivedEpi";
	String PathogenTest_dateIsolateSentSequencing="PathogenTest.dateIsolateSentSequencing";
	String PathogenTest_dateSeqResultsSentProgram="PathogenTest.dateSeqResultsSentProgram";
	String PathogenTest_w1="PathogenTest.w1";
	String PathogenTest_w2="PathogenTest.w2";
	String PathogenTest_w3="PathogenTest.w3";
	...
	String PathogenTest_dateFollowupExam="PathogenTest.dateFollowupExam";
	String PathogenTest_residualAnalysis="PathogenTest.residualAnalysis";
	String PathogenTest_resultExam="PathogenTest.resultExam";
	...
	String Sample_dateDifferentiationSentToEpi = "Sample.dateDifferentiationSentToEpi";
	String Sample_dateDifferentiationReceivedFromEpi = "Sample.dateDifferentiationReceivedFromEpi";
	...
	String Symptoms_backacheOnsetDate = "Symptoms.backacheOnsetDate";
	String Symptoms_normalCryAndSuckOnsetDate = "Symptoms.normalCryAndSuckOnsetDate";
	String Symptoms_stiffnessOnsetDate = "Symptoms.stiffnessOnsetDate";
	String Symptoms_spasmsConvulsionOnsetDate = "Symptoms.spasmsConvulsionOnsetDate";
	String Symptoms_feverOnsetDate = "Symptoms.feverOnsetDate";
	String Symptoms_coughOnsetDate = "Symptoms.coughOnsetDate";
	String Symptoms_runnyNoseOnsetDate = "Symptoms.runnyNoseOnsetDate";
	String Symptoms_conjunctivitisOnsetDate = "Symptoms.conjunctivitisOnsetDate";
	String Symptoms_feverOnsetParalysisOnsetDate = "Symptoms.feverOnsetParalysisOnsetDate";
	String Symptoms_progressiveParalysisOnsetDate = "Symptoms.progressiveParalysisOnsetDate";
	String Symptoms_progressiveFlaccidAcuteOnsetDate = "Symptoms.progressiveFlaccidAcuteOnsetDate";
	String Symptoms_assymetricOnsetDate = "Symptoms.assymetricOnsetDate";
	String Symptoms_siteOfParalysisOnsetDate = "Symptoms.siteOfParalysisOnsetDate";
	...
	String Symptoms_rapidBreathingOnsetDate = "Symptoms.rapidBreathingOnsetDate";
	String Symptoms_congenitalHeartDiseaseOnsetDate = "Symptoms.congenitalHeartDiseaseOnsetDate";
	String Symptoms_cataractsOnsetDate = "Symptoms.cataractsOnsetDate";
	String Symptoms_congenitalGlaucomaOnsetDate = "Symptoms.congenitalGlaucomaOnsetDate";
	String Symptoms_pigmentaryRetinopathyOnsetDate = "Symptoms.pigmentaryRetinopathyOnsetDate";
	String Symptoms_hearinglossOnsetDate = "Symptoms.hearinglossOnsetDate";
	String Symptoms_purpuricRashOnsetDate = "Symptoms.purpuricRashOnsetDate";
	String Symptoms_microcephalyOnsetDate = "Symptoms.microcephalyOnsetDate";
	String Symptoms_meningoencephalitisOnsetDate = "Symptoms.meningoencephalitisOnsetDate";
