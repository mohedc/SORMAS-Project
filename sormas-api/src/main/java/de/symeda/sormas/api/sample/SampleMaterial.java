...
public enum SampleMaterial {
	...
	BLOOD,
	@Diseases(value = {
			Disease.RESPIRATORY_SYNCYTIAL_VIRUS, Disease.INVASIVE_PNEUMOCOCCAL_INFECTION, Disease.YELLOW_FEVER, Disease.MEASLES, Disease.CONGENITAL_RUBELLA }, hide = true)
	SERA,
	@Diseases(value = {
	...
	NP_ASPIRATE,
	@Diseases(value = {
			Disease.RESPIRATORY_SYNCYTIAL_VIRUS, Disease.INVASIVE_MENINGOCOCCAL_INFECTION, Disease.YELLOW_FEVER, Disease.MEASLES}, hide = true)
	PLEURAL_FLUID,
	@Diseases(value = {
			Disease.YELLOW_FEVER, Disease.MEASLES}, hide = true)
	CLINICAL_SAMPLE,
	@Diseases(value = {
			Disease.INVASIVE_MENINGOCOCCAL_INFECTION, Disease.YELLOW_FEVER, Disease.MEASLES}, hide = true)
	PERITONEAL_FLUID,
	@Diseases(value = {
			Disease.YELLOW_FEVER, Disease.MEASLES}, hide = true)
	SYNOVIAL_FLUID,
