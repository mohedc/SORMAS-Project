...
public class CaseFacadeEjb extends AbstractCoreFacadeEjb<Case, CaseDataDto, CaseIndexDto, CaseReferenceDto, CaseService, CaseCriteria>
	...
	private String generateEpidNumber(String caseUuid, Disease disease, Date reportDate, String districtUuid) {
		...
		String regionCode = regionParts != null ? regionParts[1] : getEpidCodePart(region.getEpidCode(), region.getName());
	...
	public static CaseDataDto toCaseDto(Case source) {
		...
		target.setMenacSourceOfVaccination(source.getMenacSourceOfVaccination());
		target.setMenacw(source.getMenacw());
		target.setMenacwDate(source.getMenacwDate());
		target.setMenacwSourceOfVaccination(source.getMenacwSourceOfVaccination());
		target.setMenacwy(source.getMenacwy());
		target.setMenacwyDate(source.getMenacwyDate());
		target.setMenacwySourceOfVaccination(source.getMenacwySourceOfVaccination());
		target.setMenaConjunate(source.getMenaConjunate());
		target.setMenaConjunateDate(source.getMenaConjunateDate());
		target.setMenaConjunateSourceOfVaccination(source.getMenaConjunateSourceOfVaccination());
		target.setPcvi3I(source.getPcvi3I());
		target.setPcvi3IDate(source.getPcvi3IDate());
		target.setPcvi3ISourceOfVaccination(source.getPcvi3ISourceOfVaccination());
		target.setPcvi3_2(source.getPcvi3_2());
		target.setPcvi3_2Date(source.getPcvi3_2Date());
		target.setPcvi3_2SourceOfVaccination(source.getPcvi3_2SourceOfVaccination());
		target.setPcv13_3(source.getPcv13_3());
		target.setPcv13_3Date(source.getPcv13_3Date());
		target.setPcv13_3SourceOfVaccination(source.getPcv13_3SourceOfVaccination());
		target.setHibI(source.getHibI());
		target.setHibIDate(source.getHibIDate());
		target.setHibISourceOfVaccination(source.getHibISourceOfVaccination());
		target.setHib2(source.getHib2());
		target.setHib2Date(source.getHib2Date());
		target.setHib2SourceOfVaccination(source.getHib2SourceOfVaccination());
		target.setHib3(source.getHib3());
		target.setHib3Date(source.getHib3Date());
		target.setHib3SourceOfVaccination(source.getHib3SourceOfVaccination());
