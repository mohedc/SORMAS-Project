...
public class SymptomsDtoHelper extends AdoDtoHelper<Symptoms, SymptomsDto> {
	...
	public void fillInnerFromDto(Symptoms target, SymptomsDto source) {
		...
		target.setCataracts(source.getCataracts());
		target.setCauseOfDeath(source.getCauseOfDeath());
		target.setBackacheOnsetDate(source.getBackacheOnsetDate());
		target.setNormalCryAndSuckOnsetDate(source.getNormalCryAndSuckOnsetDate());
		target.setStiffnessOnsetDate(source.getStiffnessOnsetDate());
		target.setSpasmsConvulsionOnsetDate(source.getSpasmsConvulsionOnsetDate());
		target.setFeverOnsetDate(source.getFeverOnsetDate());
		target.setCoughOnsetDate(source.getCoughOnsetDate());
		target.setRunnyNoseOnsetDate(source.getRunnyNoseOnsetDate());
		target.setConjunctivitisOnsetDate(source.getConjunctivitisOnsetDate());
		target.setFeverOnsetParalysisOnsetDate(source.getFeverOnsetParalysisOnsetDate());
		target.setProgressiveParalysisOnsetDate(source.getProgressiveParalysisOnsetDate());
		target.setProgressiveFlaccidAcuteOnsetDate(source.getProgressiveFlaccidAcuteOnsetDate());
		target.setAssymetricOnsetDate(source.getAssymetricOnsetDate());
		target.setSiteOfParalysisOnsetDate(source.getSiteOfParalysisOnsetDate());
		target.setParalysedLimbSensitiveToPainOnsetDate(source.getParalysedLimbSensitiveToPainOnsetDate());
		target.setInjectionSiteBeforeOnsetParalysisOnsetDate(source.getInjectionSiteBeforeOnsetParalysisOnsetDate());
		target.setInjectionSiteOnsetDate(source.getInjectionSiteOnsetDate());
		target.setArthralgiaOnsetDate(source.getArthralgiaOnsetDate());
		target.setMyalgiaOnsetDate(source.getMyalgiaOnsetDate());
		target.setJaundiceOnsetDate(source.getJaundiceOnsetDate());
		target.setHemorrhagicSyndromeOnsetDate(source.getHemorrhagicSyndromeOnsetDate());
		target.setOtherNonHemorrhagicSymptomsOnsetDate(source.getOtherNonHemorrhagicSymptomsOnsetDate());
		target.setHeadacheOnsetDate(source.getHeadacheOnsetDate());
		target.setNeckStiffnessOnsetDate(source.getNeckStiffnessOnsetDate());
		target.setBulgingFontanelleOnsetDate(source.getBulgingFontanelleOnsetDate());
		target.setVomitingOnsetDate(source.getVomitingOnsetDate());
		target.setAlteredConsciousnessOnsetDate(source.getAlteredConsciousnessOnsetDate());
		target.setSeizuresOnsetDate(source.getSeizuresOnsetDate());
		target.setRapidBreathingOnsetDate(source.getRapidBreathingOnsetDate());
		target.setCongenitalHeartDiseaseOnsetDate(source.getCongenitalHeartDiseaseOnsetDate());
		target.setCataractsOnsetDate(source.getCataractsOnsetDate());
		target.setCongenitalGlaucomaOnsetDate(source.getCongenitalGlaucomaOnsetDate());
		target.setPigmentaryRetinopathyOnsetDate(source.getPigmentaryRetinopathyOnsetDate());
		target.setHearinglossOnsetDate(source.getHearinglossOnsetDate());
		target.setPurpuricRashOnsetDate(source.getPurpuricRashOnsetDate());
		target.setMicrocephalyOnsetDate(source.getMicrocephalyOnsetDate());
		target.setMeningoencephalitisOnsetDate(source.getMeningoencephalitisOnsetDate());
