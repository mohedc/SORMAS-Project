...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
	...
	public void onUpgrade(SQLiteDatabase db, ConnectionSource connectionSource, int oldVersion, int newVersion) {
		...
		try {
			...
			case 373:
				currentVersion = 373;
				getDao(Hospitalization.class).executeRaw("ALTER TABLE hospitalizations ADD COLUMN hospitalRecordNumber varchar(255);");
				getDao(Hospitalization.class).executeRaw("ALTER TABLE hospitalizations ADD COLUMN serialNumberInConsultationRegister varchar(255);");
				getDao(Hospitalization.class).executeRaw("ALTER TABLE hospitalizations ADD COLUMN dateOfConsultationAtHealthFacility INTEGER;");
				getDao(Hospitalization.class).executeRaw("ALTER TABLE hospitalizations ADD COLUMN dateHealthRegionNotified INTEGER;");
				getDao(Hospitalization.class).executeRaw("ALTER TABLE hospitalizations ADD COLUMN address varchar(512);");
			case 374:
				currentVersion = 374;
				getDao(EpiData.class).executeRaw("ALTER TABLE epidata ADD COLUMN motherRubellaLabConfirmed varchar(255);");
				getDao(EpiData.class).executeRaw("ALTER TABLE epidata ADD COLUMN motherRubellaLabConfirmedDate INTEGER;");
				getDao(EpiData.class).executeRaw("ALTER TABLE epidata ADD COLUMN motherExposedDuringPregnancy varchar(255);");
				getDao(EpiData.class).executeRaw("ALTER TABLE epidata ADD COLUMN motherExposedDuringPregnancyDate INTEGER;");
				getDao(EpiData.class).executeRaw("ALTER TABLE epidata ADD COLUMN gestationalAgeAtExposure INTEGER;");
				getDao(EpiData.class).executeRaw("ALTER TABLE epidata ADD COLUMN exposureLocationDescription varchar(255);");
				getDao(EpiData.class).executeRaw("ALTER TABLE epidata ADD COLUMN motherTraveledDuringPregnancy varchar(255);");
				getDao(EpiData.class).executeRaw("ALTER TABLE epidata ADD COLUMN motherTraveledDuringPregnancyDate INTEGER;");
				getDao(EpiData.class).executeRaw("ALTER TABLE epidata ADD COLUMN gestationalAgeAtTravel INTEGER;");
				getDao(EpiData.class).executeRaw("ALTER TABLE epidata ADD COLUMN travelLocationDescription varchar(255);");
			case 375:
				currentVersion = 375;
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN clinicianName varchar(255);");
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN clinicianAddress varchar(255);");
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN clinicianPhone varchar(255);");
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN autopsyConducted varchar(255);");
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN autopsyFindings varchar(255);");
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN autopsyDate INTEGER;");
			case 376:
				currentVersion = 376;
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN dateFormCsfDispatchedToHealthDistrict INTEGER;");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN dateHealthFacilityNotifyRegion INTEGER;");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN lumbarPuncturePerformed varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN dateOfLp INTEGER;");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN lpAspect varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN lpPackaging varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN lpPackagingOther varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN wasSpecimenTaken varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN laboratoryType varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN dateSpecimenSentToLaboratoryType INTEGER;");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN packaging varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN packagingOther varchar(255);");
			case 377:
				currentVersion = 377;
			...
			case 379:
				currentVersion = 379;
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN measlesCommunityInvestigation varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN measlesInvestigationResults varchar(512);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN finalClassification varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN finalClassificationDiscarded varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN classificationByOrigin varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN menac varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN menacDate BIGINT;");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN menacw varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN menacwDate BIGINT;");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN menacwy varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN menacwyDate BIGINT;");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN menaConjunate varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN menaConjunateDate BIGINT;");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN pcvi3I varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN pcvi3IDate BIGINT;");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN pcvi3_2 varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN pcvi3_2Date BIGINT;");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN pcv13_3 varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN pcv13_3Date BIGINT;");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN hibI varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN hibIDate BIGINT;");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN hib2 varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN hib2Date BIGINT;");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN hib3 varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN hib3Date BIGINT;");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN districtNotificationDate BIGINT;");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN personFullName varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN personTelephone varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN personDesignation varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN dateFormSentToDistrict BIGINT;");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN dateFormReceivedAtDistrict BIGINT;");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN dateFormSentToRegion BIGINT;");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN dateFormReceivedAtRegion BIGINT;");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN dateFormSentToNational BIGINT;");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN dateFormReceivedAtNational BIGINT;");
				getDao(MaternalHistory.class).executeRaw("ALTER TABLE maternalHistory ADD COLUMN rubellaVaccination varchar(255);");
				getDao(MaternalHistory.class).executeRaw("ALTER TABLE maternalHistory ADD COLUMN rubellaVaccinationDate BIGINT;");
				getDao(MaternalHistory.class).executeRaw("ALTER TABLE maternalHistory ADD COLUMN rubellaMonth INTEGER;");
				getDao(MaternalHistory.class).executeRaw("ALTER TABLE maternalHistory ADD COLUMN motherRubellaLabConfirmed varchar(255);");
				getDao(MaternalHistory.class).executeRaw("ALTER TABLE maternalHistory ADD COLUMN motherRubellaLabConfirmedDate BIGINT;");
				getDao(MaternalHistory.class).executeRaw("ALTER TABLE maternalHistory ADD COLUMN gestationalAgeAtExposure INTEGER;");
				getDao(MaternalHistory.class).executeRaw("ALTER TABLE maternalHistory ADD COLUMN exposureLocationDescription varchar(255);");
				getDao(MaternalHistory.class).executeRaw("ALTER TABLE maternalHistory ADD COLUMN motherTraveledDuringPregnancy varchar(255);");
				getDao(MaternalHistory.class).executeRaw("ALTER TABLE maternalHistory ADD COLUMN motherTraveledDuringPregnancyDate BIGINT;");
				getDao(MaternalHistory.class).executeRaw("ALTER TABLE maternalHistory ADD COLUMN gestationalAgeAtTravel INTEGER;");
				getDao(MaternalHistory.class).executeRaw("ALTER TABLE maternalHistory ADD COLUMN travelLocationDescription varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN elisaIgm varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN elisaIgmDate BIGINT;");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN pcr varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN pcrDate BIGINT;");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN prnt varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN prntInputValue varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN prntDate BIGINT;");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN barcode varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN csfSampleCollected varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN lpNotDoneReason varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN lpNotDoneReasonOther varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN timeOfInoculationIntoTransportMedia BIGINT;");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN samplesNotSentReason varchar(512);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN dateTimeSampleSentToLab BIGINT;");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN sampleContainerUsed varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN sampleContainerUsedOther varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN meningitisRdtPerformed varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN meningitisRdtResult varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN labNumber varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN sampleContainerReceived varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN sampleContainerReceivedOther varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN sampleConditionAtReception varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN csfAppearanceAtCollection varchar(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN csfAppearanceAtReception varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN virusDetectionGenotype varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN virusIsolated INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN macroscopicExamination varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN cellCountNormal INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN cellCountAbnormal INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN wbcCountPolycytesPercent varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN wbcCountMonocytesPercent varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN gramStainResult varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN agglutinationResult varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN agglutinationPositiveResults varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN agglutinationOtherMicroorganism varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN dateResultsSentToRegion BIGINT;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN otherTestsPending INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN otherTestsPendingSpecify varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN dateResultsSentToReferenceLaboratory BIGINT;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN referenceLaboratory_id BIGINT;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN selectedPathogenTestTypesString text;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN cultureFindingsString text;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN pcrFindingsString text;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN cultureOtherGermsSpecify varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN pcrOtherGermsSpecify varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN cellCountLeucocytesPerMm3 varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN csfGlucose varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN csfProtein varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN gramStainGpd INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN gramStainGnd INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN gramStainGpb INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN gramStainGnb INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN gramStainOtherPathogens INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN gramStainOtherPathogensSpecify varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN gramStainNoOrganismSeen INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN latexNmA INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN latexNmC INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN latexNmWY INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN latexNmBEcoliKi INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN latexSPneumoniae INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN latexHib INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN latexStrepB INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN latexNegative INTEGER;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN rdtDipstickPerformed varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN rdtDipstickResults varchar(512);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN ceftriaxoneSusceptibility varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN ampicillinSusceptibility varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN gentamycinSusceptibility varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN oxacillinSusceptibility varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN chloramphenicolSusceptibility varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN benzylPenicillinSusceptibility varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN otherAntimicrobialDrugName varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN otherAntimicrobialSusceptibility varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN datePcrPerformed BIGINT;");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN pcrTypeText varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN pcrSerotype varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN otherTestTypeSpecify varchar(255);");
				getDao(PathogenTest.class).executeRaw("ALTER TABLE pathogenTest ADD COLUMN otherTestResults text;");
			case 380:
				currentVersion = 380;
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN headacheOnsetDate INTEGER;");
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN neckStiffnessOnsetDate INTEGER;");
			...
			case 383:
				currentVersion = 383;
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN department varchar(512);");
			case 384:
				currentVersion = 384;
				getDao(Person.class).executeRaw("ALTER TABLE person ADD COLUMN phone varchar(512);");
				getDao(Person.class).executeRaw("ALTER TABLE person ADD COLUMN emailAddress varchar(512);");
			case 385:
				currentVersion = 385;
				getDao(Location.class).executeRaw("ALTER TABLE location ADD COLUMN nearestHealthFacility varchar(512);");
			case 386:
				currentVersion = 386;
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN arthralgia varchar(255);");
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN myalgia varchar(255);");
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN cataracts varchar(255);");
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN causeOfDeath varchar(512);");
			case 387:
				currentVersion = 387;
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN spasmsConvulsion varchar(255);");
			...
			case 395:
				...
				getDao(AfpImmunization.class).executeRaw(
					"CREATE TABLE afpimmunization(" + "id integer primary key autoincrement," + "uuid varchar(36) not null,"
						+ "changeDate timestamp not null," + "creationDate timestamp not null," + "lastOpenedDate timestamp,"
						+ "localChangeDate timestamp not null," + "modified integer," + "snapshot integer," + "pseudonymized boolean,"
						+ "totalNumberDoses integer," + "opvDoseAtBirth timestamp," + "secondDose timestamp," + "fourthDose timestamp,"
						+ "firstDose timestamp," + "thirdDose timestamp," + "lastDose timestamp,"
						+ "totalOpvDosesReceivedThroughSia varchar(512)," + "totalOpvDosesReceivedThroughRi varchar(512),"
						+ "dateLastOpvDosesReceivedThroughSia timestamp," + "totalIpvDosesReceivedThroughSia varchar(512),"
			...
			case 397:
				currentVersion = 397;
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN csfSampleCollected varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN lpNotDoneReasonString varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN lpNotDoneReasonOther varchar(255);");

			case 398:
				currentVersion = 398;
				getDao(Person.class).executeRaw("ALTER TABLE person ADD COLUMN mothersPhoneNumber varchar(255);");
				getDao(Person.class).executeRaw("ALTER TABLE person ADD COLUMN fathersPhoneNumber varchar(255);");
			case 399:
				currentVersion = 399;
				getDao(Person.class).executeRaw("ALTER TABLE person ADD COLUMN caregiverName varchar(255);");

			case 400:
				currentVersion = 400;
				getDao(Hospitalization.class).executeRaw("ALTER TABLE hospitalizations ADD COLUMN dateOfDiseaseOnset BIGINT;");

			case 401:
				currentVersion = 401;
				getDao(Contact.class).executeRaw("ALTER TABLE contacts ADD COLUMN contactProximities varchar(512);");
				getDao(Contact.class).executeRaw("UPDATE contacts SET contactProximities = contactProximity WHERE contactProximity IS NOT NULL;");
	...
	private void upgradeFromUnupgradableVersion(SQLiteDatabase db, ConnectionSource connectionSource, int oldVersion) {
		try {
			...
			TableUtils.dropTable(connectionSource, AfpImmunization.class, true);
